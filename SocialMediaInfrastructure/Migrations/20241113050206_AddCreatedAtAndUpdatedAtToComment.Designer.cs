...
namespace SocialMediaInfrastructure.Migrations
{
    ...
    [Migration("20241113050206_AddCreatedAtAndUpdatedAtToComment")]
    partial class AddCreatedAtAndUpdatedAtToComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommentLikes", b =>
                {
                    b.HasOne("SocialMediaDomain.Entities.Comment", null)
                        .WithMany()
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SocialMediaDomain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostLikes", b =>
                {
                    b.HasOne("SocialMediaDomain.Entities.Post", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMediaDomain.Entities.Comment", b =>
                {
                    b.HasOne("SocialMediaDomain.Entities.User", "Commenter")
                        .WithMany("Comments")
                        .HasForeignKey("CommenterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMediaDomain.Entities.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SocialMediaDomain.Entities.Post", b =>
                {
                    b.HasOne("SocialMediaDomain.Entities.User", "Author")
                        .WithMany("Posts")
